...
class HomeController extends Controller
{
    ...
    public function welcome()
    {
        ...
        return view('welcome', compact('new_arrival', 'feature', 'tranding', 'popular_product', 'best_selling','sliders', 'menu_categories', 'categories', 'bestsell_product', 'brands', 'home_categories', 'feature_product', 'new_product', 'bestsell_product', 'trending_product'));
    }
