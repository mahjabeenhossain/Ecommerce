                ...
                <div class="col-md-6">
                    ...
                    <div id="" class="panel panel-default">
                        ...
                        <div class="panel-body panel_area">
                            <div class="form-group">
                                <label>Full Name</label>
                                <input type="text" class="form-control" name="shipping_name" value="{{Auth::user()->name}}" placeholder="Your Name" required>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                            ...
                            <div class="form-group">
                                <label>Phone</label>
                                <input required type="text" id="phone" class="form-control" placeholder="Phone Number" name="shipping_phone" value="{{Auth::user()->phone}}">
                            </div>
                            <div class="form-group">
                                <label>Address</label>
