    ...
    <div class="best_selling_section  py-4 grey-section ">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">   
                    <div class="d-flex align-items-center justify-content-center">
                        <a href="{{route('tranding.product')}}" class="btn-product vbtn-sm text-capitalize" title="View More">view more<i class="fa fa-angle-double-right ml-2" aria-hidden="true"></i></a>
                    </div>
                </div>    
            </div>
        </div>
